module.exports = {
  ...
  Token:
    process.env.Token ||
    "MTEwNDAyNDk5MDgyODk4NjQ2OA.Gl_gTF.q4eOBauofOL6GcPgzL9Q7-OKsdwDf-7XDRdk1s", // Discord Bot Token
  ClientID: process.env.Discord_ClientID || "1104024990828986468", // Discord Client ID
  ClientSecret:
    process.env.Discord_ClientSecret || "KzMS_ReCm_B2yhXoF9QL7I6QSGQb16fF", // Discord Client Secret
  ...
  Lavalink: {
    ...
    host: "lavalink.alexanderof.xyz", //- The host name or IP of the lavalink server.
    port: 2333, // The port that lavalink is listening to. This must be a number!
    pass: "lavalink", //- The password of the lavalink server.
